...
// 7 Given an array of names ["Ali", "Ali Hussan", "Ali Haider", "Gulam Ali", "Ali Shan"], use the forEach method to log each name with an exclamation mark at the end, e.g., "Alice!".

const namesArray: string[] = ["Ali", "Ali Hussan", "Ali Haider", "Gulam Ali", "Ali Shan"];
